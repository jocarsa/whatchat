...
function dameMensajes(resultado){
    ...
    for(var i = 0;i<resultado.length;i++){
        ...
        if(resultado[i].usuarioemisor == usuario){
        document.getElementById("mensajes").innerHTML += '<div class="mensaje yo"><div class="nombreusuario">'+resultado[i].usuarioemisor+'</div><div class="momento">'+fecha+'</div>'+resultado[i].mensaje+'</div>'
            ...
            document.getElementById("mensajes").innerHTML += '<div class="mensaje otros"><div class="nombreusuario">'+resultado[i].usuarioemisor+'</div><div class="momento">'+fecha+'</div>'+resultado[i].mensaje+'</div>'
        }
    }
...
document.getElementById("botonsignin").addEventListener("click",function(){
    ...
    nuevocontrasena = document.getElementById("nuevocontrasena").value
    nuevonombre = document.getElementById("nuevonombre").value
    nuevoapellidos = document.getElementById("nuevoapellidos").value
    nuevoemail = document.getElementById("nuevoemail").value
    nuevotelefono = document.getElementById("nuevotelefono").value
    cadena = '/servidor/registra.php?nuevousuario='+nuevousuario+'&nuevocontrasena='+nuevocontrasena+'&nuevonombre='+nuevonombre+'&nuevoapellidos='+nuevoapellidos+'&nuevoemail='+nuevoemail+'&nuevotelefono='+nuevotelefono
    console.log(cadena)
    fetch(url+cadena)
